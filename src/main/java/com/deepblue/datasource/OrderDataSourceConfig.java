package com.deepblue.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.deepblue.bloom.mapper","com.deepblue.product.mapper"}, sqlSessionTemplateRef = "OrderSqlSessionTemplate")
